...
public final class ClientConfigurationNetworking {
     ...
     * @see ClientConfigurationNetworking#unregisterGlobalReceiver(ResourceLocation)
     * @see ClientConfigurationNetworking#registerReceiver(ResourceLocation, ConfigurationChannelHandler)
     */
     ...
     * @see ClientConfigurationNetworking#registerGlobalReceiver(ResourceLocation, ConfigurationChannelHandler)
     * @see ClientConfigurationNetworking#unregisterReceiver(ResourceLocation)
     */
    @Nullable
    public static ClientConfigurationNetworking.ConfigurationChannelHandler unregisterGlobalReceiver(ResourceLocation channelName) {
     ...
     */
    public static boolean registerReceiver(ResourceLocation channelName, ConfigurationChannelHandler channelHandler) {
     ...
     */
    @Nullable
    public static ClientConfigurationNetworking.ConfigurationChannelHandler unregisterReceiver(ResourceLocation channelName) throws IllegalStateException {
        final ClientConfigurationNetworkAddon addon = ClientNetworkingImpl.getClientConfigurationAddon();
     ...
     * @return a new packet
     */
    public static Packet<ServerCommonPacketListener> createC2SPacket(ResourceLocation channelName, FriendlyByteBuf buf) {
    ...
    private static <T extends FabricPacket> ResolvablePayload.Handler<ClientConfigurationNetworkAddon.Handler> wrapTyped(PacketType<T> type, ConfigurationPacketHandler<T> actualHandler) {
        return new ResolvablePayload.Handler<>(type, actualHandler, (client, handler, payload, responseSender) -> {
            ...
            if (client.isSameThread()) {
                ...
                client.execute(() -> {
                    if (((ClientCommonNetworkHandlerAccessor) handler).getConnection().isConnected()) {
                        actualHandler.receive(packet, responseSender);
                    }
                });
            }
    ...
    public interface ConfigurationChannelHandler {
         ...
         */
        void receive(Minecraft client, ClientConfigurationPacketListenerImpl handler, FriendlyByteBuf buf, PacketSender responseSender);
    }
