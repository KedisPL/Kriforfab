...
public final class ServerConfigurationNetworking {
     ...
     * @see ServerConfigurationNetworking#registerReceiver(ServerConfigurationPacketListenerImpl, ResourceLocation, ConfigurationChannelHandler)
     */
    public static boolean registerGlobalReceiver(ResourceLocation channelName, ConfigurationChannelHandler channelHandler) {
     ...
     * Use {@link #unregisterReceiver(ServerConfigurationPacketListenerImpl, PacketType)} to unregister the existing handler.
     *
     ...
     * @see ServerConfigurationNetworking#registerReceiver(ServerConfigurationPacketListenerImpl, PacketType, ConfigurationPacketHandler)
     */
     ...
     * @see ServerConfigurationNetworking#registerGlobalReceiver(ResourceLocation, ConfigurationChannelHandler)
     * @see ServerConfigurationNetworking#unregisterReceiver(ServerConfigurationPacketListenerImpl, ResourceLocation)
     */
    @Nullable
    public static ServerConfigurationNetworking.ConfigurationChannelHandler unregisterGlobalReceiver(ResourceLocation channelName) {
     ...
     * @see ServerConfigurationNetworking#unregisterReceiver(ServerConfigurationPacketListenerImpl, PacketType)
     */
    @Nullable
    ...
    /**
     * Registers a handler to a channel.
     * This method differs from {@link ServerConfigurationNetworking#registerGlobalReceiver(ResourceLocation, ConfigurationChannelHandler)} since
     ...
     * Use {@link #unregisterReceiver(ServerConfigurationPacketListenerImpl, ResourceLocation)} to unregister the existing handler.
     *
     * <p>For new code, {@link #registerReceiver(ServerConfigurationPacketListenerImpl, PacketType, ConfigurationPacketHandler)}
     * is preferred, as it is designed in a way that prevents thread safety issues.
     *
     ...
     */
    public static boolean registerReceiver(ServerConfigurationPacketListenerImpl networkHandler, ResourceLocation channelName, ConfigurationChannelHandler channelHandler) {
     ...
     * @see ServerPlayConnectionEvents#INIT
     */
    public static <T extends FabricPacket> boolean registerReceiver(ServerConfigurationPacketListenerImpl networkHandler, PacketType<T> type, ConfigurationPacketHandler<T> handler) {
     ...
     */
    @Nullable
    public static ServerConfigurationNetworking.ConfigurationChannelHandler unregisterReceiver(ServerConfigurationPacketListenerImpl networkHandler, ResourceLocation channelName) {
        Objects.requireNonNull(networkHandler, "Network handler cannot be null");
     ...
     * @return the previous handler, or {@code null} if no handler was bound to the channel,
     * or it was not registered using {@link #registerReceiver(ServerConfigurationPacketListenerImpl, PacketType, ConfigurationPacketHandler)}
     */
    @Nullable
    public static <T extends FabricPacket> ServerConfigurationNetworking.ConfigurationPacketHandler<T> unregisterReceiver(ServerConfigurationPacketListenerImpl networkHandler, PacketType<T> type) {
     ...
     */
    public static boolean canSend(ServerConfigurationPacketListenerImpl handler, PacketType<?> type) {
        Objects.requireNonNull(handler, "Server configuration network handler cannot be null");
     ...
     */
    public static void send(ServerConfigurationPacketListenerImpl handler, ResourceLocation channelName, FriendlyByteBuf buf) {
        ...
        handler.send(createS2CPacket(channelName, buf));
    }
     ...
     */
    public static <T extends FabricPacket> void send(ServerConfigurationPacketListenerImpl handler, T packet) {
        Objects.requireNonNull(handler, "Server configuration handler cannot be null");
        Objects.requireNonNull(packet, "Packet cannot be null");
        Objects.requireNonNull(packet.getType(), "Packet#getType cannot return null");

        handler.send(createS2CPacket(packet));
    }
    ...
    public interface ConfigurationChannelHandler {
         ...
         */
        void receive(MinecraftServer server, ServerConfigurationPacketListenerImpl handler, FriendlyByteBuf buf, PacketSender responseSender);
    }
    ...
    public interface ConfigurationPacketHandler<T extends FabricPacket> {
         ...
         * @see FabricPacket
         */
        void receive(T packet, ServerConfigurationPacketListenerImpl networkHandler, PacketSender responseSender);
    }
}
